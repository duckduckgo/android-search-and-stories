...
public class DDGConstants {
	public static String BASE_URL = "https://www.duckduckgo.com/";
...
//	public static final String USER_AGENT = "Mozilla/5.0 (compatible; Googlebot/2.1; +http://www.google.com/bot.html)";
	public static final String AUTO_COMPLETE_URL = BASE_URL + "ac/?q=";
	public static final String SEARCH_URL = BASE_URL + "?ko=-1&q=";
    public static final String SEARCH_URL_JAVASCRIPT_DISABLED = BASE_URL + "html/?q=";
