...
public class PullToRefreshMainFeedListView extends PullToRefreshAdapterViewBase<MainFeedListView> {
	...
	public PullToRefreshMainFeedListView(Context context) {
		super(context);
		setDisableScrollingWhileRefreshing(false);
	}

	public PullToRefreshMainFeedListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		setDisableScrollingWhileRefreshing(false);
	}

	public PullToRefreshMainFeedListView(Context context, Mode mode) {
		super(context, mode);
		setDisableScrollingWhileRefreshing(false);
	}
	...
	protected MainFeedListView createListView(Context context, AttributeSet attrs) {
		final MainFeedListView lv;
	...
	@Override
	protected final MainFeedListView createRefreshableView(Context context, AttributeSet attrs) {
		MainFeedListView lv = createListView(context, attrs);
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(PullToRefreshMainFeedListView.this, deltaY, scrollY, isTouchEvent);

			return returnValue;
		}
	}

	protected class InternalListView extends MainFeedListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			PullToRefreshMainFeedListView.this.setEmptyView(emptyView);
		}
